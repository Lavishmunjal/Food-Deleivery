...
import { removeToCart } from '../redux/slice/CartSlice.jsx'

const ItemCart = ({id, name, price, img, qty}) => {
  const dispatch = useDispatch()
  return (
    <div className='flex gap-2 shadow-md rounded-lg p-2 mb-3'>
      <MdDelete onClick={()=>dispatch(removeToCart(id))} className=' absolute right-7 text-gray-600 cursor-pointer'/>
      <img src={img} alt="" className='w-[65px] h-50px'/>
